...
class _HorrorPageState extends State<HorrorPage> {
  ...
  final String urltrending1 =
      "https://api.themoviedb.org/3/discover/movie?api_key=b3683b201570bdba7301facb6448362c&with_genres=27&page=2";
  final String urltrending2 =
      "https://api.themoviedb.org/3/discover/movie?api_key=b3683b201570bdba7301facb6448362c&with_genres=27&page=3";
  final String urltrending3 =
      "https://api.themoviedb.org/3/discover/movie?api_key=b3683b201570bdba7301facb6448362c&with_genres=27&page=4";
  final String urltrending4 =
      "https://api.themoviedb.org/3/discover/movie?api_key=b3683b201570bdba7301facb6448362c&with_genres=27&page=5";
  final String urltrending5 =
      "https://api.themoviedb.org/3/discover/movie?api_key=b3683b201570bdba7301facb6448362c&with_genres=27&page=6";
  List<HorrorMovies> horrormovies1 = [];
   @override
  void initState() {
    getJsonData();
  ...
  Future getJsonData() async {
    ...
    setState(() {
      for (var i in jsonDatatrending1['results']) {
        HorrorMovies horror1 = HorrorMovies(
            title: i["title"],
            overview: i['overview'],
            ...
            id: i['id']);
        horrormovies1.add(horror1);
      }
      for (var i in jsonDatatrending2['results']) {
        HorrorMovies horror2 = HorrorMovies(
            title: i["title"],
            overview: i['overview'],
            poster_path: i['poster_path'],
            original_language: i['original_language'],
            ...
            backdrop_path: i['backdrop_path'],
            id: i['id']);
        horrormovies1.add(horror2);
      }
      for (var i in jsonDatatrending3['results']) {
        HorrorMovies horror3 = HorrorMovies(
            title: i["title"],
            overview: i['overview'],
            poster_path: i['poster_path'],
            original_language: i['original_language'],
            ...
            backdrop_path: i['backdrop_path'],
            id: i['id']);
        horrormovies1.add(horror3);
      }
      for (var i in jsonDatatrending4['results']) {
        HorrorMovies horror4 = HorrorMovies(
            title: i["title"],
            overview: i['overview'],
            poster_path: i['poster_path'],
            original_language: i['original_language'],
            ...
            backdrop_path: i['backdrop_path'],
            id: i['id']);
        horrormovies1.add(horror4);
      }
      for (var i in jsonDatatrending5['results']) {
        HorrorMovies horror5 = HorrorMovies(
            title: i["title"],
            overview: i['overview'],
            poster_path: i['poster_path'],
            original_language: i['original_language'],
            ...
            body: SingleChildScrollView(
              child:Container(
                child:Column(
                  ...
                  children: new List<Widget>.generate(horrormovies1.length,
                      (index) {
                    return Container(
                      child: Column(
                        children: [
